...
export class AppLayoutComponent implements OnDestroy {
    ...
    get containerClass() {
        return {
            ...
            'layout-nested-menu': this.layoutService.config.nestedMode && (this.layoutService.config.menuMode=='reveal' || this.layoutService.config.menuMode=='static'|| this.layoutService.config.menuMode=='overlay' ),
